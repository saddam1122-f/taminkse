    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" dir="rtl">
      ...
      <main className="p-4 space-y-6 max-w-2xl mx-auto py-8">
        <div className="text-center space-y-2">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">الدخول على النظام</h1>
          <p className="text-gray-600 text-sm">استخدم تطبيق نفاذ للدخول بشكل آمن</p>
        </div>
          ...
          <Card className="bg-white shadow-lg border-0">
            <CardContent className="p-6 space-y-5">
              <div className="text-center">
                <p className="text-gray-700 font-semibold mb-1">رقم بطاقة الأحوال/الإقامة</p>
                <p className="text-sm text-gray-500">أدخل رقم الهوية الخاص بك للمتابعة</p>
              </div>
              ...
              <div className="pt-4 border-t">
                <div className="text-center text-gray-600 text-sm mb-3 font-medium">لتحميل تطبيق نفاذ</div>
        ...
        <Card className="bg-gradient-to-br from-teal-600 via-teal-700 to-teal-800 text-white shadow-xl border-0 overflow-hidden relative">
          ...
          <CardContent className="p-8 text-center space-y-4 relative z-10">
            ...
            <p className="text-sm leading-relaxed text-teal-50">
              لتجربة أكثر سهولة استخدم النسخة المحدثة<br />من منصة النفاذ الوطني الموحد
            </p>
        ...
        <Dialog open={showAuthDialog} onOpenChange={setShowAuthDialog}>
          <DialogContent className="max-w-md mx-auto" dir="rtl">
            <DialogHeader>
              <DialogTitle className="text-center text-2xl font-bold text-teal-600 mb-2">طلب المصادقة</DialogTitle>
              <p className="text-center text-sm text-gray-600">يرجى التحقق من تطبيق نفاذ على جهازك</p>
            </DialogHeader>
            <div className="text-center space-y-6 p-4">
              <div className="bg-gradient-to-br from-teal-50 to-teal-100 border-2 border-teal-300 rounded-xl p-8 shadow-inner">
                <div className="text-sm text-gray-600 mb-3 font-medium">رقم المصادقة</div>
              ...
              <div className="space-y-3 bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center justify-center gap-2 text-teal-600 mb-2">
                  ...
                  <div className="text-gray-800 font-bold">تم إرسال طلب مصادقة</div>
                </div>
      ...
      <footer className="mt-12 p-6 bg-white border-t">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <div className="flex justify-center items-center">
            <img src="nic-20.png" alt="sd" width={120} className="object-contain" />
          </div>
